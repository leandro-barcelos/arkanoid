    ...
    public Integer colisao(MatrizBlocos objeto) {
        ...
        for (int i = 0; i < objeto.getMatriz().length; i++)
            for (int j = 0; j < objeto.getMatriz()[i].length; j++){
                ...
                boolean colisao = getY() >= objeto.getMatriz()[i][j].getY() - objeto.getMatriz()[i][j].getHeight() / 2  && getX() > objeto.getMatriz()[i][j].getX() - objeto.getMatriz()[i][j].getHeight() / 2 && getX() < objeto.getMatriz()[i][j].getX() + objeto.getMatriz()[i][j].getWidth() / 2;
